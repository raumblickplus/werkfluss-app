...
function pfadFuer(id: string) {
  ...
  if (id === 'foerdermittel') return '/foerdermittel'
  if (id === 'kommunikation') return '/kommunikation'
...
export default function AppShell({
  ...
  function istAktiv(id: string) {
    ...
    if (id === 'foerdermittel') return location.pathname === '/foerdermittel'
    if (id === 'kommunikation') return location.pathname === '/kommunikation'
